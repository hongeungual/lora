...
checkpoint_path = "./final-lora-weight/adalora_coastal/checkpoint-5000"
...
# 프롬프트 - 더 구체적이고 명확하게
V = "boisversionsrai"
prompt = f"a photorealistic coastal {V} interior room, highly detailed"
...
with torch.no_grad():
    generated_images = pipe(
        ...
        controlnet_conditioning_scale=[0.4, 0.5], # ControlNet 강도 대폭 낮춤
        strength=1.0,  # img2img 강도 낮춤
        guidance_scale=8.0,  # CFG 낮춤
...
for i, img in enumerate(generated_images):
    ...
    # 정리된 이미지 저장
    filename = f"./adalora_coastal_cleaned_{i}.jpg"
